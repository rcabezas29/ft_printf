...
static void	ft_parseflags(t_struct *ps, char *format)
{
	if (format[ps->i] == '#')
	{
		ps->flags[0] = 1;
...
static void	ft_parsemodifiers(t_struct *ps, char *format)
{
...
static void	ft_parsespecs(t_struct *ps, char *format)
{
